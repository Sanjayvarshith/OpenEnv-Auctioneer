...
(Direct Gemini API version for local testing)
"""
...
def run_task(task_id: str) -> float:
    ...
    while not done:
        # State test (optional, to verify it works)
        _current_state = env.state()
